...
from kuttappi import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL


#Needed to dynamically load modules
#NOTE: Module order is not guaranteed, specify that in the config file!
from kuttappi.modules import ALL_MODULES
from kuttappi.modules.helper_funcs.chat_status import is_user_admin
from kuttappi.modules.helper_funcs.misc import paginate_modules
from kuttappi.modules.translations.strings import tld, tld_help
from kuttappi.modules.connection import connected
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("kuttappi.modules." + module_name)
